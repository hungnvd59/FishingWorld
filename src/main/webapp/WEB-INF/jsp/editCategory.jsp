...
<meta name="description" content="Chỉnh sửa danh mục">
		...
		<div class="content-wrapper">
			...
			<form action="categoryManager/save" method="POST"
				...
				<fieldset>
					...
					<!-- Form Name -->
					<legend>Chỉnh sửa danh mục sản phẩm</legend>
					<!-- Select Basic -->
						...
						<div class="col-md-4 inputGroupContainer">
							<div class="input-group">
								<span class="input-group-addon"><i
								 ...
								 <input name="id" placeholder="Nhập id" value="${categories.categoryId}" class="form-control" />
							</div>
						</div>
					</div>
					<br>
					...
					<div class="form-group">
						...
						<div class="col-md-4 inputGroupContainer">
							<div class="input-group">
								<span class="input-group-addon"><i
									class="glyphicon glyphicon-book"></i></span>
								<input name="name" placeholder="Nhập ma danh muc" value="${categories.categoryName}" class="form-control"/>
							</div>
						</div>
					</div>
					<br>
