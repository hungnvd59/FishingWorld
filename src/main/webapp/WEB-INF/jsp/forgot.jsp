				...
				<div class="col-lg-12 col-md-12">
					...
					<article class="blog-full">
						<div class="comment-respond">
							<h3 class="comment-reply-title">Gửi mail lấy lại mật khẩu</h3>
							<span class="email-notes">Địa chỉ email của bạn sẽ không bị công khai</span>
							<span><Strong style="color: red;">${err}</Strong></span>
							<form action="sendMail" method="get">
								<div class="row">
									<div class="col-md-4">
										<p>Địa chỉ Email *</p>
										
										<input type="email" path="mailaddress" name="mailsend"/>
									</div>
