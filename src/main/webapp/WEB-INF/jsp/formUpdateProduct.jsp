	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<div class="container">
				<!-- Main content -->
				${message}
				<form:form action="saveChangeProduct" modelAttribute="productForm"
						...
						<div class="form-group">
							...
							<div class="col-md-4 selectContainer">
								<div class="input-group">
									...
									<form:select path="category.categoryId" items="${Categories}"
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									...
									<form:input path="quantity" class="form-control" type="file" />
								</div>
							</div>
						</div>
						<br>
						...
						<div class="form-group">
							...
							<div class="col-md-10 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-pencil"></i></span>
									<form:textarea path="blog" id="blog1" class="form-control" />
								</div>
							</div>
						</div>
						<br>
