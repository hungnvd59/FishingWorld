					...
					<article class="blog-full">
						...
						<div class="post-wrapper">
							...
							<div class="post-info-blog">
								<h2 class="post-tile">
									<a href="#">Hướng dẫn mua hàng qua tư vấn trực tuyến</a>
								</h2>
								...
								<div class="entry-summary">
									<p>Để tiến hàng đặt mua,các bạn làm như sau</p>
									<p>1.Ngay dưới góc phía dưới bên phải mà hình các bạn sẽ
										thấy nút " Tư vấn trực tuyến" Click vào đó</p>
									<p>
										<img src="static/images/suport/tructuyen1.png" alt=""
											width="800px" height="450px" />
									</p>
									<p>2.Lúc này,trình nhắn tín sẽ bật lên,mọi thắc mắc bạn cần
										hỏi có thể gửi ở đây,chúng tôi có người trực 24/7</p>
									<p>- Nếu đặt hàng,các bạn chỉ cần gửi cho chúng tôi đường
										link sản phẩm cùng số lượng,màu sắc,kích cỡ kèm theo số điện
										thoại liên hệ,địa chỉ nhận hàng.</p>
									<p>
										<img src="static/images/suport/tructuyen2.png" alt=""
											width="800px" height="450px" />
									</p>
									<p>3.Ngay khi nhận được đơn hàng,chúng tôi sẽ gọi điện lại
										theo thông tin bạn lưu lại để xác nhận đơn hàng.</p>
