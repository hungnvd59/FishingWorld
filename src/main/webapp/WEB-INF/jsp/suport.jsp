				...
				<div class="col-lg-12 col-md-12">
					...
					<article class="blog-full">
						...
						<div class="post-wrapper">
							<div class="post-date">
								<span class="day">Fishing World hướng dẫn mua hàng</span> <span
									class="month"></span>
							</div>
							<div class="post-info-blog">
								...
								<div class="entry-summary">
									<div class="col-md-6">
										<p>
											<img src="static/images/suport/tuvantructiep.PNG" alt=""
												width="800px" height="400px" />
										</p>
										<br>
										<a href="tructuyen"><h3 style="color:red">Hướng dẫn mua hàng qua TƯ VẤN TRỰC TUYẾN</h3></a>
									</div>
									<div class="col-md-6">
										<p>
											<img src="static/images/suport/muahangtrenPC.PNG" alt=""
												width="800px" height="450px" />
										</p>
										<br>
										<p></p>
										<p></p>
										<a href="muaPC"><h3 style="color:red">Hướng dẫn mua hàng trên PC</h3></a>
									</div>
								</div>
