...
<!-- rs-plugin CSS
		============================================ -->
<link href="static/assets/lib/rs-plugin/css/settings.css" rel="stylesheet" />
...
<body class="home-5">
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="about-us-img">
						<img src="static/assets/img/about/about.jpg" alt="" />
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<div class="about-text">
						<h3>CẢM ƠN BẠN ĐÃ ĐẾN VỚI FISHING WORLD</h3>
						<p>Câu cá là một môn thể thao giải trí hết sức tuyệt vời sau
							những giờ làm việc căng thẳng. Hãy tận hưởng cảm giác của những
							tay câu chuyên nghiệp với các loại cần câu mà Fishing World mang đến
							cho các bạn hôm nay.</p>
						<p>Fishing World là nhà cung cấp đồ câu cá, các loại cần câu
							cá giá rẻ, hay máy câu cá chính hãng chất lượng cao trên toàn
							quốc với mục đích đem đến những trải nghiệm câu cá tốt nhất cho
							các cần thủ.</p>
						<p>Chúng tôi cung cấp đầy đủ các dụng cụ câu cá, đa dạng chủng
							loại, nhiều hãng nổi tiếng trên thế giới. Các loại máy câu đứng,
							máy câu ngang, cần câu rút, cần câu tay hay các loại cần câu máy,
							lưỡi câu cá, phao câu cá hay phụ kiện câu cá khác.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Lib js -->
	<script src="static/assets/lib/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
	<script src="static/assets/lib/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
	...
	<!-- footer-top-area end --> <!-- footer-bootom-area start -->
