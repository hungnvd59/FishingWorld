					...
					<article class="blog-full">
						...
						<div class="post-wrapper">
							...
							<div class="post-info-blog">
								<h2 class="post-tile">
									<a href="#">Hướng dẫn mua hàng trên PC</a>
								</h2>
								<div class="entry-meta-small">
									/ Đăng bởi <span class="author-info"><a href="#">Fishing
											World</a></span> /
								</div>
								<div class="entry-summary">
									<p>Để tiến hàng đặt hàng trực tiếp trên website trên giao
										diện PC,mời các bạn làm theo hướng dẫn sau.</p>
									<p>Click vào xem chi tiết để xem hình ảnh chi tiết,giá và
										thông số của sản phẩm</p>
									<p>
										<img src="static/images/suport/PC1.png" alt="" width="800px"
											height="450px" />
									</p>
									<p>Thêm số lượng sản phẩm cần đặt mua vào ô nhỏ bên dưới.</p>
									<p>Click vào thêm sản phẩm vào giỏ để tiến hành đặt hàng</p>
									<p>
										<img src="static/images/suport/PC2.png" alt="" width="800px"
											height="450px" />
									</p>
									<p>Hoặc click vào thêm vào giỏ hàng ngay</p>
									<p>
										<img src="static/images/suport/PC3.png" alt="" width="800px"
											height="450px" />
									</p>
									<p>Click vào xem giỏ hàng để xem sản phẩm vừa chọn</p>
									<p>Click vào đặt hàng nếu bạn muốn đặt hàng ngay</p>
									<p>
										<img src="static/images/suport/PC4.png" alt="" width="800px"
											height="450px" />
									</p>
									<p>Điền đầy đủ thông tin để tiến hành đặt hàng</p>
									<p>Đặt hàng thành công sẽ có thông báo như hình</p>
									<p>
										<img src="static/images/suport/PC5.png" alt="" width="800px"
											height="450px" />
									</p>
									<p>Sau khi xác nhận đơn hàng,chúng tôi sẽ tiến hàng giao
										hàng cho các bạn trong thời gian nhanh nhất.</p>
									<p style="color: red">Để hủy đơn hàng. Quý khách vui lòng
										liên hệ với chúng tôi trước 18h cùng ngày.</p>
									<p>Cám ơn các bạn đã tin tưởng mua hàng trên Fishing World</p>
									<p>Chúc các bạn 1 ngày vui vẻ,tràn ngập may mắn!Chúc những
										chuyến câu luôn đầy ắp niềm vui và chiến lợi phẩm!</p>
								</div>
